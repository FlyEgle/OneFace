...
from models.layers import DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, create_attn, create_classifier
...
default_cfgs = {
    # ResNet vd which from bag of tricks for image classification by zhanghang  
    'resnet50d': _cfg(
